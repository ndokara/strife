...
export const inputsCustomizations: Components<CustomTheme> = {
    MuiButtonBase: {
        defaultProps: {
        ...
        styleOverrides: {
            ...
            input: ({ theme }) => ({
                ...
                '&:autofill': {
                    ...
                    backgroundColor: 'calc(infinity * 1s) step-end',
                    backgroundImage: 'calc(infinity * 1s) step-end allow-discrete',
                    WebkitBoxShadow: '0 0 0px 1000px transparent inset !important',
                    boxShadow: '0 0 0 40px {COLOR} inset !important',
